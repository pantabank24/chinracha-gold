...
export const PalladiumPage = ({
  ...
  const [XPDPrice, setXPDPrice] = React.useState<string | null>("0");
  ...
  const validateXPDPriceInput = (i: string) => {
    if (/^\d*\.?\d*$/.test(i)) {
      if (parseInt(i) < 0) {
        setXPDPrice("0");
      } else {
                  ...
                  <div className={`flex items-center w-full gap-2`}>
                    <div className={`flex items-center w-full gap-2`}>
                      <Input
                        ...
                        min="0"
                        max="100"
                        value={XPDPrice ?? "10000"}
                        onValueChange={(e) => validateXPDPriceInput(e)}
                      />
                    </div>
                    <Input
