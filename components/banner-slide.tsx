        ...
        <div className=" flex w-auto rounded-full">
          <Marquee className=" text-sm" pauseOnHover pauseOnClick>
            <span className="font-bold  text-sm ml-3 bg-gradient-to-b from-yellow-100 to-yellow-500 bg-clip-text text-transparent">
              ...
              น้ำหนักทอง) = ราคาทองที่จะได้รับ ร้านมี 2 สาขา สาขา1 ตลาดทิพเนตร
              เชียงใหม่ สาขา2 ตลาดจตุจักร ลำพูน
              สะดวกใกล้ที่ไหนไปที่สาขานั้นได้เลยครับ ไม่สะดวกมา โทรมาปรึกษากัน
              แล้วส่งพัสดุมาได้ ทางร้านยินดีดูแลให้ครับ
            </span>
          </Marquee>
        </div>
      </div>
